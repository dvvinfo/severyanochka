...
import type { CatalogSection, CatalogStore } from '@/types/catalog'
...
export const useCatalogStore = defineStore('catalog', () => {
  ...
  const setCatalogSections = (sections: CatalogSection) => {
    catalog.sections = sections
  }

  return { setCatalogSections,CatalogSections, catalog }
})
